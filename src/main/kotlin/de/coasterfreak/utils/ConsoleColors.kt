...
object ConsoleColors {
    fun systemMessage(message: String) {
        println("$Background_Magenta$YELLOW$Bold » $message « $RESET")
    }

    fun errorMessage(message: String) {
        println("$Background_Red$YELLOW$Bold » $message « $RESET")
    }

    fun cmdMessage(message: String) {
        println("$Background_Green$PURPLE$Bold » $message « $RESET")
    }
}